...
function Add({match}) {
  const [data, setData] = useState([{ engine_number: '', location: 'home', road: '', 'is_operational': true}]);
      ...
      <Pane>
        <Formik
          ...
          onSubmit={(values, { setSubmitting }) => {
            axios.post('/api/v1/locomotives/', values)
            .then(/* istanbul ignore next */function (response) {
                ...
                <ul>
                  ...
                  <li data-testid="engine_number">
                    <FormField label="Engine Number" >
                      <Field id="engine_number" type="text" name="engine_number" placeholder="" />
                    </FormField>
                    <Error>
                  ...
                  <li>
                    <Button type="submit" data-testid="locomotiveAdd-submit" disabled={isSubmitting}>
                      Submit
                    </Button>
                  </li>
                </ul>
